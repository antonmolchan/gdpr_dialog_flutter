...
public class ConsentForm {
    ...
    public void load(FormStyle style, String languageCode) {
        ...
        String html = new HtmlReader(context).readHtml(languageCode);
        String styledHtml = new Styler().getStyledHtml(html, style);
        this.webView.loadDataWithBaseURL("file:///android_asset/", styledHtml, "text/html", "UTF-8", null);
    }
