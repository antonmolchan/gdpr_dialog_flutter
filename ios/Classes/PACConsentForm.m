...
- (void)loadWithStyle:(nullable EGADialogStyle*)style
         languageCode:(nullable NSString*)languageCode
    completionHandler:(nonnull PACLoadCompletion)loadCompletion {
  ...
  PACLoadCompletion wrappedLoadCompletion = ^(NSError *_Nullable error) {
    ...
    [pacView loadWithFormInformation:formInformation
                               style:style
                        languageCode:languageCode
                   completionHandler:wrappedLoadCompletion];
}
